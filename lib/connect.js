...
var CONNECTION_CONFIG_PROPS =
  "loginUrl,forceUrl,accessToken,instanceUrl,refreshToken,clientId,clientSecret,redirectUri,logLevel,version".split(',');
...
function connect(options) {
  ...
  return Promise.resolve().then(function() {
    ...
    } else if (options.forceUrl) {
      conn = new jsforce.Connection({ forceUrl: options.forceUrl })
    } else {
      throw new Error(
